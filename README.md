...
Once the GUI is running, pick a data folder to list JSON files (recursive), or add files directly. Use the “Reset View” button if you pan/zoom and want to snap the axes back to the current data bounds.
