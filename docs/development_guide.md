...
4. **GUI / Orchestration Layer**
   - PySide6 application with panels for file selection, summary statistics, quick visualization toggles (line/scatter/etc.), and future controls for interpretation cards.
